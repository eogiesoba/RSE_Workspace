...
int main(int argc, char** argv)
{
    ...
    // Get ROS start time. Loop should run once
    ...
    while (ros::ok()) {
        ...
        // Set the arm joint angles. This will run a predfined path/trajectory between -pi/2 and pi/2 as time elapses until
        // ROS node receives signal to shutdown either from ROS master or console window
