...
int main()
{
    ...
    Robot p3[n]; // New particle set which will take in the new resampled particles.
    int index = gen_real_random() * n; //This will randomly pick a particle. "int" will make number from float to integer
    //if number is not already an integer.
     
    //cout << index << endl;
    double beta = 0.0; // This will set our initial beta value to 0.0
