...
int main()
{
    ...
    for (int t = 0; t < steps; t++) {
        ...
        // Each number generated denotes the average distance between the particles and the robot in a world of 100mx100m. 
        // Notice how the number starts relatively high and converges to a smaller number after several iterations.
           cout << "Step = " << t << ", Evaluation = " << evaluation(myrobot,p,n) << " meters" << endl;
